...
const FeaturedRoom: FC<Props> = props => {
  ...
  return (
    <section className='flex md:flex-row flex-col px-10 py-10 items-center gap-36 container mx-auto'>
      <div className='md:grid gap-0 grid-cols-1'>
        ...
        <div className='grid grid-cols-2 gap-8 h-0'>
